...
<div class="container mx-auto">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl overflow-hidden shadow-md p-6">
            <h3 class="text-lg font-semibold mb-2">Nome Utente 1</h3>
            <div class="flex items-center mb-2">
                ...
                <!-- Aggiungi altre stelle necessarie -->
            </div>
            <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget risus eget nunc
                vestibulum venenatis sed sed dolor.</p>
        </div>

        <!-- Recensione 2 -->
        <div class="bg-white rounded-xl overflow-hidden shadow-md p-6">
            <!-- Simile alla Recensione 1 -->
        </div>
