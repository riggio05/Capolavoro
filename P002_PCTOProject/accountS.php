...
<body class="bg-gray-100 dark:bg-gray-800">
    ...
    <div class="container mx-auto py-10 px-4 lg:px-6">
        ...
        <div id="student-info" class="max-w-md mx-auto"></div>
    </div>

    <script>
        // Funzione per ottenere i dati dello studente dal server
        function getStudentData() {
            fetch('http://localhost/P002_PCTOProject/student/accountS', {
                method: 'GET',
                headers: {
                            ...
                            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg shadow-lg p-6">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700">${student.surname}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="w-20 font-semibold">Classe:</span>
                                        <span class="text-gray-700">${student.class || 'Non assegnata'}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="w-20 font-semibold">Indirizzo:</span>
                                        <span class="text-gray-700">${student.address}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="w-20 font-semibold">CAP:</span>
                                        <span class="text-gray-700">${student.CAP}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="w-20 font-semibold">Mail:</span>
                                        <span class="text-gray-700">${student.mail}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="w-20 font-semibold">Azienda:</span>
                                        <span class="text-gray-700">${student.agency || 'Nessuna azienda assegnata'}</span>
                                    </div>
