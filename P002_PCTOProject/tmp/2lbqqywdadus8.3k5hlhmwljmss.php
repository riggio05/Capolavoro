    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
                <a href="#"
                    class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Account</a>
...
<body>
    ...
    <div class="flex item-center mx-5 justify-center mt-16">
        <div class="max-w-4xl bg-white rounded-lg flex overflow-hidden">
            <div class="w-1/2">
                <img src="../../${agency.img}" alt="Azienda" class="object-cover h-full w-full">
            </div>
            <div class="w-1/2 p-8">
                ...
                <div>
                    ...
                    <ul class="text-gray-700">
                        <li>Nome del Tutor 1</li>
                        <li>Nome del Tutor 2</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <a href="http://localhost/P002_PCTOProject/student/aziende/visita/preferiti?id=${agency.id}">
    <button type="button"
