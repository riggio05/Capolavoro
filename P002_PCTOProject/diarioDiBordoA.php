    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
                <a href="http://localhost/P002_PCTOProject/administrator/account" id="accountBtn" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Account</a>
...
<form method="POST" action="http://localhost/P002_PCTOProject/api/administrator/studenti/visita/diariodibordo">
...
<body>
    ...
    <div id="diariodibordo" class="grid grid-cols-3 gap-4">
        ...
        <script>
            ...
            function fetchLogbook() {
                fetch('../../../api/administrator/studenti/visita/diariodibordo?id=' + id)
                    .then(response => response.json())
                    .then(data => {
                        const container = document.getElementById('diariodibordo');
                        let html = '';

                        // Controllo se data è un array prima di usare forEach
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div>
                            ...
                            // Nessun diario di bordo trovato
