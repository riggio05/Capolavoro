...
<head>
    ...
    <link rel="icon" type="image/ico" href="img/image.ico"> 
...
<body>
    <h1 class="text-center mt-7 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
        ...
        <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-600">amministratore</span>
    </h1>
    <p class="text-center mb-5 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Gestisci al meglio i
        tuoi studenti</p>
    <div class="container mx-auto px-6">
        <div class="h-64 rounded-md overflow-hidden bg-cover bg-center"
            style="background-image: url(../img/studentihome.png)">
            <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                <div class="px-10 max-w-xl">
                    <h2 class="text-2xl text-white font-semibold">Studenti</h2>
                    <p class="mt-2 text-gray-200">Gestisci al meglio i tuoi studenti</p>
                    <a href="http://localhost/P002_PCTOProject/administrator/studenti">
                        <button
            ...
            <div class="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:w-1/2"
                ...
                <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                    <div class="px-10 max-w-xl">
                        ...
                        <p class="mt-2 text-gray-200">Esplora le aziende in modo semplice</p>
                        <a href="http://localhost/P002_PCTOProject/administrator/aziende">
                            <button
            ...
            <div class="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:mt-0 md:w-1/2"
                ...
                <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                    <div class="px-10 max-w-xl">
                        ...
                        <p class="mt-2 text-gray-200">Resta in contatto con i tutor</p>
                        <button
                            class="flex items-center mt-4 text-white text-sm uppercase font-medium rounded hover:underline focus:outline-none">
                            <span>Visita</span>
                            <svg class="h-5 w-5 mx-2" fill="none" stroke-linecap="round" stroke-linejoin="round"
